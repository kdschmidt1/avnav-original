...
const AisLayer=function(mapholder){
	...
	*/
	...
	AisLayer.prototype.drawTargetSymbol=function(drawing,xy,current,drawTargetFunction,drawEstimated){
		...
		//window.setInterval(this.step, 100, this, drawing, xy)
    					...
    					if(current.warning)
    					{
    						...
    						else
    						{
    							...
    							layer.getSource().on('addfeature', function (e) {
    								...
    								//layer.dispatchEvent(new olVectorSourceEvent('addfeatures', null, features));
    								/*
    								layers=this.mapholder.olmap.getAllLayers()
